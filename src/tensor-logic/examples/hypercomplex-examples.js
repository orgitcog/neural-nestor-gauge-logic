 ...
 */
import { complex, quaternion, octonion, } from '../hypercomplex';
import { createComplexTensor, createQuaternionTensor, createHypercomplexTensor, hypercomplexEinsum, complexReLU, extractRealParts, hypercomplexTensorToString, } from '../hypercomplex-tensor';
...
export function complexFourierNetwork() {
    ...
    const input = createComplexTensor('input', ['i'], [3], [
    ...
    const weights = createComplexTensor('weights', ['o', 'i'], [2, 3], [
...
export function quaternion3DRotationNetwork() {
    ...
    const input = createQuaternionTensor('orientations', ['b'], // batch dimension
    [2], [
    ...
    const weights = createQuaternionTensor('transforms', ['o', 'b'], [2, 2], [
...
export function sedenionOverParameterizedSystem() {
    ...
    const tensor = createHypercomplexTensor('sedenions', ['i'], [2], AlgebraType.Sedenion, 'random');
...
// RUN ALL EXAMPLES
// ============================================================================
export function runAllHypercomplexExamples() {
    console.clear();
    console.log('╔' + '═'.repeat(70) + '╗');
